...
+function()
{
	...
	var POW_RANGE = 0.1;		//补偿范围(基于诞生速度)

	function SPEED_X(){return 1 + RND() * 4}
	...
	{	
		...
		var bObj = document.getElementById("me0");
		bObj.onclick = function () {
           window.open("https://ohgood.github.io");
       }
		styBox = oBox.style;
		...
		for(var i=0; i<4; i++)
		{
			...
			if(i == 3)
			{
				if(_IE6_)
					...
					sty.backgroundImage = "url(img/heart"+m+".png)";
				break;
			}
